...
func edgewise(rtm *slack.RTM, msg *slack.MessageEvent) {
	...
	case stringMatch(msg.Text, "lino"):
		img = randomResponse(
	...
	case stringMatch(msg.Text, "negro", "kevin", "brian", "jenny", "kirchner", "cfk", "cristina", "cristi", "feminazi", "todes"):
	...
	case stringMatch(msg.Text, "juegue", "jueguee", "juegueeee", " jj", "jj ", "jotajota"):
		img = randomResponse("https://i.imgur.com/DpL9Smd.gif")
		imgs = append(imgs, img)
		match = true


	case stringMatch(msg.Text, "simon", "stellaccio", "testing"):
		img = randomResponse("https://i.imgflip.com/36xhf4.jpg", "https://i.imgflip.com/36xini.jpg", "https://i.imgflip.com/36xna2.jpg")
		imgs = append(imgs, img)
		match = true

	case stringMatch(msg.Text, "boris", "gaston", "figini"):
	...
	case stringMatch(msg.Text, "corvetto", "ptp no anda", "latency"):
		img = randomResponse("https://i.imgflip.com/36xiin.jpg", "https://i.imgflip.com/36xijv.jpg")
		imgs = append(imgs, img)
		match = true

	case stringMatch(msg.Text, "rima no anda", "primarydma"):
	...
	case stringMatch(msg.Text, "river", "boca", "escritorio"):
		img = randomResponse("https://i.imgflip.com/36xmiz.jpg")
		imgs = append(imgs, img)
		match = true

	case stringMatch(msg.Text, "juanfra", "camps", "gordo boris", "jota", "investigacion", "desarrollo", "luqui", "cami", "marce"):
		img = randomResponse("https://k31.kn3.net/taringa/2/3/6/6/6/9/01/lizbelle/ECD.jpg")
		imgs = append(imgs, img)
		match = true

	case stringMatch(msg.Text, "candela", "la moto"):
	...
	case stringMatch(msg.Text, "comercial", "titi", "cuchi", "minion"):
	...
	case stringMatch(msg.Text, "suerte", "facha", "tower", "manu", "devops"):
	...
	case stringMatch(msg.Text, "juanfra", "ganador", "winner", "harem", "facha"):
		img = randomResponse("https://i.imgflip.com/37e21c.jpg")
		imgs = append(imgs, img)
		match = true

	case stringMatch(msg.Text, "login", "buscar", "buscando", "minado"):
	...
	case stringMatch(msg.Text, "arquants", "lino"):
	...
	var finalImg = imgs[rand.Intn(len(imgs))]
